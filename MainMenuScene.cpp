...
MainMenuScene::MainMenuScene(GameConfig& config) : config(config) {
    ...
    startText->setPosition({ 100.f, 300.f });
...
void MainMenuScene::render(sf::RenderWindow& window) {
    // Отрисовка фона (исправлена для optional)
